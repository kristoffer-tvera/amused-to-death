                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/character/?id=<?php echo $character['id']; ?>" class="text-reset"><?php echo $character['name']; ?></a>
                                        </td>
                                        <td>
                                            <?php
                                            ...
                                            ?>
                                                        <a href="/character/?id=<?php echo $mainCharacter['id']; ?>" class="text-reset"><?php echo $mainCharacter['name']; ?></a>
                                            <?php
                                                    }
                                                }
                                            }
