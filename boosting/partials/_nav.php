<?php 
    $nav[] = array('name' => 'Home', 'icon' => 'fe fe-home', 'href' => 'index.php');
    $nav[] = array('name' => 'Raids', 'icon' => 'fe fe-database', 'href' => 'raids.php');
    $nav[] = array('name' => 'Characters', 'icon' => 'fe fe-users', 'href' => 'characters.php');
