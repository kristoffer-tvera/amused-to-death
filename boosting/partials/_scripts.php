    ...
    <!-- <script src="/boosting/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js"></script> -->
    <!-- <script src="/boosting/assets/libs/jquery/dist/jquery.slim.min.js"></script> -->
    <!-- Tabler Core -->
    <script src="/boosting/assets/js/tabler.min.js"></script>
